...
contract GelatoDutchX is IcedOut {
    ...
    string constant execDepositAndSellTriggerString
        = "execDepositAndSellTrigger(uint256,address,address,uint256,uint256,uint256)";

    string constant execDepositAndSellActionString
        = "execDepositAndSellAction(uint256,address,address,uint256,uint256,uint256,uint256)";

    string constant execWithdrawTriggerString
        = "execWithdrawTrigger(uint256,address,address,uint256,uint256)";

    string constant execWithdrawActionString
        = "execWithdrawAction(uint256,address,address,uint256,uint256)";
        ...
        external
    {
        ...
        (uint256 num, uint256 den) = dutchExchange.closingPrices(_sellToken,
                                                                 _buyToken,
                                                                 _lastParticipatedAuctionIndex
        );
        ...
        returns(bool)
    {
        ...
        uint256 prepaymentAmount;
        {
            ...
            require(funcSelector == bytes4(
                keccak256(bytes(execDepositAndSellActionString))),
                "Only execDepositAndSell claims can be cancelled"
            );
